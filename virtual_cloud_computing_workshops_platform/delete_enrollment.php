<?php
    ...
    if(isset($_REQUEST['enrollment_id'])) {
        ...
        // Prepare and execute the DELETE statement for the enrollments table
        ...
        <body>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if ($stmt->execute()) {
                    ...
                    echo "<a href='enrollment.php'>OK</a>"; // Assuming enrollments.php is the page displaying enrollment records
                } else {
